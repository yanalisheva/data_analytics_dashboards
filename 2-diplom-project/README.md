...
### Сравнение регионов и результат теста повышения цен
![Регионы](screenshots/01-regions.png)

### Retention rate и прогноз LTV по когортам
![LTV](screenshots/02-ltv.png)

### Воронка конверсии по этапам сайта
![Воронка](screenshots/03-funnel.png)

### Конверсия и время на страницах в разрезе устройств и источников
![Кластеры](screenshots/04-devices.png)
